...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Haru Class</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="{{route('admin.home')}}">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{route('admin.basicClass')}}">
              <i class="bi bi-circle"></i><span>Basic Class</span>
            </a>
          </li>
          <li>
            <a href="{{route('admin.n5Class')}}">
              <i class="bi bi-circle"></i><span>N5 Class</span>
            </a>
          </li>
          <li>
            <a href="{{route('admin.n4Class')}}">
              <i class="bi bi-circle"></i><span>N4 Class</span>
            </a>
          </li>
        </ul>
